    ...
    <section className="about">
      <div className="about-container">
        ...
        <p>
          ...
          having the right people in the right roles and are committed to helping
          our clients find the best talent for their engineering needs.
        </p>

        <p>
          Our recruitment services are flexible and tailored to meet the unique
          needs of each client. We work closely with our clients to understand
          their requirements and deliver personalized recruitment solutions —
          from identifying potential candidates to conducting interviews and
          finalizing job offers.
        </p>
        ...
        <ul className="about-list">
          ...
          <li>
            <strong>Candidate Sourcing:</strong> Database searches, networking,
            and headhunting to identify ideal candidates.
          </li>
          <li>
          ...
          <li>
            <strong>Job Offers:</strong> Supporting offer negotiations including
            salary and benefits.
          </li>
          <li>
            <strong>Onboarding:</strong> Ensuring a smooth transition for new hires.
          </li>
        </ul>
        ...
        <p className="about-closing">
          Thank you for considering TALME as your engineering partner.
